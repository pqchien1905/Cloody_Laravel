<?php $__env->startSection('title', 'Folders - CloudBOX'); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-3">
                            <h5 class="mb-0"><?php echo e($folders->count()); ?></h5>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-3">
                            ...
                            ?>
                            <h5 class="mb-0"><?php echo e($totalFiles); ?></h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-3">
                            <h5 class="mb-0"><?php echo e($folders->where('is_favorite', true)->count()); ?></h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-3">
                            <h5 class="mb-0"><?php echo e($folders->where('is_public', true)->count()); ?></h5>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body" style="overflow: visible;">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <form method="GET" action="<?php echo e(route('cloudbox.folders.index')); ?>">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="search" placeholder="Search folders..." value="<?php echo e(request('search')); ?>">
                        ...
                        <div class="col-md-3">
                            <select class="form-control" onchange="window.location.href='?filter='+this.value">
                                ...
                                <option value="favorites" <?php echo e(request('filter') == 'favorites' ? 'selected' : ''); ?>>Favorites</option>
                                <option value="shared" <?php echo e(request('filter') == 'shared' ? 'selected' : ''); ?>>Shared</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            <select class="form-control" onchange="window.location.href='?sort='+this.value">
                                ...
                                <option value="files_count" <?php echo e(request('sort') == 'files_count' ? 'selected' : ''); ?>>Files Count</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <?php if($folders->count() > 0): ?>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="folder-row" data-url="<?php echo e(route('cloudbox.folders.show', $folder->id)); ?>">
                                            <td onclick="event.stopPropagation();">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input folder-checkbox" 
                                                           id="folder<?php echo e($folder->id); ?>" value="<?php echo e($folder->id); ?>">
                                                    <label class="custom-control-label" for="folder<?php echo e($folder->id); ?>"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <i class="ri-folder-3-fill font-size-20" style="color: <?php echo e($folder->color ?? '#3498db'); ?>"></i>
                                                    <div class="ml-3">
                                                        <span class="font-weight-bold"><?php echo e($folder->name); ?></span>
                                                        <?php if($folder->is_favorite): ?>
                                            ...
                                            <td>
                                                <?php if($folder->description): ?>
                                                    <span class="text-muted"><?php echo e(Str::limit($folder->description, 50)); ?></span>
                                                <?php else: ?>
                                            ...
                                            <td><?php echo e($folder->created_at->diffForHumans()); ?></td>
                                            <td class="actions-cell">
                                                <div class="dropdown">
                                                    <span class="action-dots" id="dropdownFolder<?php echo e($folder->id); ?>" data-toggle="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownFolder<?php echo e($folder->id); ?>">
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#editFolderModal<?php echo e($folder->id); ?>" onclick="event.preventDefault();">
                                                        ...
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#shareFolderModal<?php echo e($folder->id); ?>" onclick="event.preventDefault();">
                                                        ...
                                                        <form id="delete-folder-<?php echo e($folder->id); ?>" action="<?php echo e(route('cloudbox.folders.destroy', $folder->id)); ?>" method="POST" style="display: inline; width: 100%;" class="js-delete-form">
                                                            <?php echo csrf_field(); ?>
                                        ...
                                        <!-- Edit Folder Modal -->
                                        <div class="modal fade" id="editFolderModal<?php echo e($folder->id); ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?php echo e(route('cloudbox.folders.update', $folder->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('PUT'); ?>
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label for="name">Folder Name <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" id="name" name="name" value="<?php echo e($folder->name); ?>" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="color">Folder Color</label>
                                                                <input type="color" class="form-control" id="color" name="color" value="<?php echo e($folder->color ?? '#3498db'); ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="description">Description</label>
                                                                <textarea class="form-control" id="description" name="description" rows="3"><?php echo e($folder->description); ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Privacy Settings <span class="text-danger">*</span></label>
                                                                <div class="custom-control custom-radio mb-2">
                                                                    <input type="radio" id="edit_privacy_private<?php echo e($folder->id); ?>" name="is_public" value="0" 
                                                                           class="custom-control-input" <?php echo e(!$folder->is_public ? 'checked' : ''); ?>>
                                                                    <label class="custom-control-label" for="edit_privacy_private<?php echo e($folder->id); ?>">
                                                                        <i class="ri-lock-line"></i> Private
                                                                        <small class="d-block text-muted">Only you can access this folder</small>
                                                                    </label>
                                                                </div>
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" id="edit_privacy_public<?php echo e($folder->id); ?>" name="is_public" value="1" 
                                                                           class="custom-control-input" <?php echo e($folder->is_public ? 'checked' : ''); ?>>
                                                                    <label class="custom-control-label" for="edit_privacy_public<?php echo e($folder->id); ?>">
                                                                        <i class="ri-global-line"></i> Public
                        ...
                        <?php $__currentLoopData = $folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <!-- Share Folder Modal -->
                        <div class="modal fade" id="shareFolderModal<?php echo e($folder->id); ?>" tabindex="-1" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form action="<?php echo e(route('cloudbox.folders.share', $folder->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="share_email_folder_<?php echo e($folder->id); ?>">Recipient Email <span class="text-danger">*</span></label>
                                                <input type="email" class="form-control" id="share_email_folder_<?php echo e($folder->id); ?>" name="email" required placeholder="Enter recipient's email">
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
<script>
    ...
    if (bulkDeleteBtn) {
        bulkDeleteBtn.addEventListener('click', function() {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(route("cloudbox.folders.bulk-delete")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cloudbox-laravel1\cloudbox-laravel\resources\views/pages/folders.blade.php ENDPATH**/ ?>