                            ...
                            <a href="#" class="search-toggle dropdown-toggle d-flex align-items-center justify-content-center" id="dropdownMenuButton03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding: 0;">
                                <?php if(Auth::user()->avatar): ?>
                                    <div style="width: 40px; height: 40px; border-radius: 50%; overflow: hidden; border: 2px solid #667eea; box-shadow: 0 2px 6px rgba(102, 126, 234, 0.4);">
                                        <img src="<?php echo e(asset(Auth::user()->avatar)); ?>" alt="user" style="width: 100%; height: 100%; object-fit: cover; display: block;">
                                    </div>
                                <?php else: ?>
                                    <div class="caption bg-primary line-height"><?php echo e(strtoupper(substr(Auth::user()->name ?? 'P', 0, 1))); ?></div>
                                <?php endif; ?>
                            </a>
                                            ...
                                            <div class="cover-container text-center">
                                                <?php if(Auth::user()->avatar): ?>
                                                    <div style="width: 80px; height: 80px; margin: 0 auto;">
                                                        <img src="<?php echo e(asset(Auth::user()->avatar)); ?>" class="rounded-circle" alt="avatar" style="width: 100%; height: 100%; object-fit: cover; border: 3px solid #667eea; box-shadow: 0 4px 8px rgba(0,0,0,0.15);">
                                                    </div>
                                                <?php else: ?>
                                                ...
                                                <div class="profile-detail mt-3">
                                                    <h5><a href="<?php echo e(route('cloudbox.user.profile')); ?>"><?php echo e(Auth::user()->name ?? 'User Name'); ?></a></h5>
...
<?php /**PATH C:\laragon\www\cloudbox-laravel1\cloudbox-laravel\resources\views/partials/topnav.blade.php ENDPATH**/ ?>