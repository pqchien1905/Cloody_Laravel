...
<div class="modal fade" id="uploadFileModal" tabindex="-1" role="dialog" aria-labelledby="uploadFileModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('cloudbox.files.upload')); ?>" method="POST" enctype="multipart/form-data" id="uploadForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <?php if(isset($currentFolderId)): ?>
                        <input type="hidden" id="upload_folder_id" name="folder_id" value="<?php echo e($currentFolderId); ?>">
                    <?php else: ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkForDuplicates() {
        return new Promise((resolve) => {
            ...
            fetch(`<?php echo e(route('cloudbox.files.check-duplicates')); ?>`, {
                method: 'POST',
                headers: {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\cloudbox-laravel1\cloudbox-laravel\resources\views/partials/upload-modal.blade.php ENDPATH**/ ?>