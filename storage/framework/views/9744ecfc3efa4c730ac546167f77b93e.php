                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            <select class="form-control" onchange="window.location.href='?type='+this.value">
                                ...
                                <option value="documents" <?php echo e(request('type') == 'documents' ? 'selected' : ''); ?>>Documents</option>
                                <option value="images" <?php echo e(request('type') == 'images' ? 'selected' : ''); ?>>Images</option>
                                <option value="videos" <?php echo e(request('type') == 'videos' ? 'selected' : ''); ?>>Videos</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cloudbox-laravel\resources\views/pages/files.blade.php ENDPATH**/ ?>