    ...
    <div class="data-scrollbar" data-scroll="1">
        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="<?php echo e(request()->routeIs('cloudbox.user.*') ? 'active' : ''); ?>">
                    <a href="#otherpage" class="<?php echo e(request()->routeIs('cloudbox.user.*') ? '' : 'collapsed'); ?>" data-toggle="collapse" aria-expanded="<?php echo e(request()->routeIs('cloudbox.user.*') ? 'true' : 'false'); ?>">
                        <i class="las la-pager"></i><span>Other Page</span>
                        <i class="las la-angle-right iq-arrow-right arrow-active"></i>
                        <i class="las la-angle-down iq-arrow-right arrow-hover"></i>
                    </a>
                    <ul id="otherpage" class="iq-submenu collapse <?php echo e(request()->routeIs('cloudbox.user.*') ? 'show' : ''); ?>" data-parent="#iq-sidebar-toggle">
                        <li class="<?php echo e(request()->routeIs('cloudbox.user.*') ? 'active' : ''); ?>">
                            <a href="#user" class="<?php echo e(request()->routeIs('cloudbox.user.*') ? '' : 'collapsed'); ?>" data-toggle="collapse" aria-expanded="<?php echo e(request()->routeIs('cloudbox.user.*') ? 'true' : 'false'); ?>">
                                <i class="las la-user-cog"></i><span>User Details</span>
                                <i class="las la-angle-right iq-arrow-right arrow-active"></i>
                                <i class="las la-angle-down iq-arrow-right arrow-hover"></i>
                            </a>
                            <ul id="user" class="iq-submenu collapse <?php echo e(request()->routeIs('cloudbox.user.*') ? 'show' : ''); ?>" data-parent="#otherpage">
                                <li class="<?php echo e(request()->routeIs('cloudbox.user.profile') ? 'active' : ''); ?>"><a href="<?php echo e(route('cloudbox.user.profile')); ?>"><i class="las la-id-card-alt"></i>Profile</a></li>
                                <li class="<?php echo e(request()->routeIs('cloudbox.user.add') ? 'active' : ''); ?>"><a href="<?php echo e(route('cloudbox.user.add')); ?>"><i class="las la-plus-circle"></i>Add User</a></li>
                                <li class="<?php echo e(request()->routeIs('cloudbox.user.list') ? 'active' : ''); ?>"><a href="<?php echo e(route('cloudbox.user.list')); ?>"><i class="las la-th-list"></i>User List</a></li>
                            </ul>
                        </li>
                        <li class="">
                            ...
                            <ul id="auth" class="iq-submenu collapse" data-parent="#otherpage">
                                <li><a href="<?php echo e(route('login')); ?>"><i class="las la-sign-in-alt"></i>Login</a></li>
                                <li><a href="<?php echo e(route('register')); ?>"><i class="las la-user-plus"></i>Register</a></li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\cloudbox-laravel\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>