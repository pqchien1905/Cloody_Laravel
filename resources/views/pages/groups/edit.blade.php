...
@section('title', 'Chỉnh sửa nhóm - Cloody')
    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <div class="mb-4">
                ...
                <h4 class="mb-0">Chỉnh sửa nhóm</h4>
                <p class="text-muted">Cập nhật thông tin nhóm {{ $group->name }}</p>
            </div>
                    ...
                    <form action="{{ route('groups.update', $group) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Mô tả về mục đích và hoạt động của nhóm">{{ old('description', $group->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio mb-2">
                                <input type="radio" id="privacy_private" name="privacy" 
                                       ...
                                       {{ old('privacy', $group->privacy) === 'private' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" id="privacy_public" name="privacy" 
                                       ...
                                       {{ old('privacy', $group->privacy) === 'public' ? 'checked' : '' }}>
                        ...
                        <div class="form-group mb-0 mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="ri-save-line mr-1"></i> Cập nhật nhóm
                            </button>
                            <a href="{{ route('groups.show', $group) }}" class="btn btn-light ml-2">
                                Hủy
                            </a>
                        </div>
                    </form>
