        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        @if($file->folder)
                            <a href="{{ route('cloody.folders.show', $file->folder->id) }}" class="btn btn-sm btn-light mr-2">
                                <i class="ri-folder-3-line"></i> {{ __('common.open_folder') }}
                            </a>
                        @endif
                        <a href="{{ route('cloody.files.download', $file->id) }}" class="btn btn-sm btn-primary">
                ...
                <div class="card-body" style="min-height: 60vh; display: flex; align-items: center; justify-content: center;">
                    ...
                    @else
                        <div class="text-center py-5 w-100">
                            ...
                            <a class="btn btn-primary" href="{{ route('cloody.files.download', $file->id) }}">
                                <i class="ri-download-2-line"></i> {{ __('common.download') }}
                            </a>
